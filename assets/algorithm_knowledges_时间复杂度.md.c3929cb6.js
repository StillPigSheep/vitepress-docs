import{_ as n,o as l,c as t,Q as o}from"./chunks/framework.42a4ab43.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"algorithm/knowledges/时间复杂度.md","filePath":"algorithm/knowledges/时间复杂度.md"}'),r={name:"algorithm/knowledges/时间复杂度.md"},a=o(`<h2 id="时间复杂度" tabindex="-1">时间复杂度 <a class="header-anchor" href="#时间复杂度" aria-label="Permalink to &quot;时间复杂度&quot;">​</a></h2><p>在竞赛中，一般算机一秒能运行 5 x 10^8 次汁算，如果题目給出的时间限制カ 1s,那么你选择的算法执行的汁算次数最多应该在 10^8 量级オ有可能解决这个题目。一般 O(n)的算法能解决的数据范围在 n &lt; 10^8。</p><pre><code>  O(n *logn)的算法能解决的数据范围在n &lt;= 10^6。
